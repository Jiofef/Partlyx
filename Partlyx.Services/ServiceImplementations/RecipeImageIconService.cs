...
{
    public class RecipeImageIconService : ImageIconServiceAbstract, IRecipeImageIconService
    {
        private readonly IPartlyxRepository _repo;
        private readonly IEventBus _eventBus;
        private readonly IIconInfoProvider _infoProvider;
        public RecipeImageIconService(IPartlyxRepository repo, IEventBus bus, IIconInfoProvider iip)
        {
            _repo = repo;
            _eventBus = bus;
            _infoProvider = iip;
